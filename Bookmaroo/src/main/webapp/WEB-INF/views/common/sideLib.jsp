	...
	<nav class="bg-white sidebar fixed-left" id="sideBar">
	    <div class="sidebar-sticky text-dark" id="subCategory">
			<ul class="nav flex-column">
	        	<li class="nav-item">
	            	<a class="nav-link active s1" href="${ pageContext.servletContext.contextPath }/searchBook.lib">도서실</a>
	            </li>
	            <li class="nav-item">
	            	<a class="nav-link s2" href="${ pageContext.servletContext.contextPath }/searchBook.lib">도서검색</a>
	            </li>
	            <li class="nav-item">
