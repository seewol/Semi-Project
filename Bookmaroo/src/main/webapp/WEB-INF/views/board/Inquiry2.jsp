...
<body>
	...
	<div class="row minheight">
		...
		<div class="col-8">
			<div id="board_area">
				<a href="${ contextPath }/Inquiry.bo">문의사항</a>
				<br><br>
				...
				<div style="text-align: right;">
					<a href="postingInquiry.bo"><button class="btn btn-primary btn-default" style="background-color: #4373E6; ">문의하기</button></a>
				</div>
				<br><br>
			</div>
		</div>
	...
	<script>
		window.onload=()=>{
			...
			const theadTrTh = theadTr.querySelectorAll('th');
				...
				theadTrTh[4].style.width = '5%';
				theadTrTh[5].style.width = '15%';
				theadTrTh[6].style.width = '5%';
