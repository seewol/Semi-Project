...
<style>
	...
	#subCategory{max-width: 250px; width: 250px;}
	#subCategory a{
	...
	<nav class="bg-white sidebar fixed-left" id="sideBar">
	      <div class="sidebar-sticky text-dark" id="subCategory">
	        <ul class="nav flex-column">
	          ...
	          <li class="nav-item">
	            <a class="nav-link s2" href="${contextPath}/myInfoForm.me">내 정보 수정</a>
	          </li>
	          <li class="nav-item">
	            <a class="nav-link s2" href="${ pageContext.servletContext.contextPath }/myBooks.lib">내 서재</a>
	          </li>
        	  <li class="nav-item">
	            	<a class="nav-link s2" href="${ pageContext.servletContext.contextPath }/myHeartBooks.lib">찜한 도서</a>
	          </li>
	          <li class="nav-item">
	            <a class="nav-link s2" href="writingHistory.myPage">작성글 확인</a>
	          </li>
<!-- 	          <li class="nav-item"> -->
