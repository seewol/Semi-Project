...
<body>
	...
	<div class="row minheight">
		<div class="col-3"></div>
		<div class="col-6">
			<form id="review_form" action="insertReview.bo" method="post">
					...
					<select class="form-select" id="fs" aria-label="Default select example" onchange="selectFunc()" required>
					  <option value="" selected>리뷰 도서를 선택하세요</option>
						  <c:forEach items="${ list }" var="b">
						  	<option value="${ b.bookName }">${ b.bookName }</option>
						  </c:forEach>
					</select>
				</div>
				<div id="book_info_area" class="row">
					<div class="col-6" id="book_cover_area">
						<img src="resources/image/default_book_cover_2015.jpg" alt="이미지를 삽입해주세요" height="324px" width="216px" id="book_img">
					</div>
					<div class="col-6 row row-cols-1">
						<div class="col detail"></div>
						<div class="col detail" id="ISBN">ISBN : </div>
						<div class="col detail" id="bookName">제목 : </div>
						<div class="col detail" id="bookautor">저자 : </div>
						<div class="col detail" id="bookGenre">장르 : </div>
						<div class="col detail" id="bookPublisher">출판사 : </div>
						<div class="col detail"></div>
						<div class="col detail"></div>
					</div>
				</div>
				<div id="content_area">
					<input type="text" id="review_title" name="reviewTitle" placeholder="제목을 입력하세요" required>
					<textarea id="review_content" name="reviewContent" placeholder="내용을 입력하세요"></textarea>	
					<input type="hidden" name="starRating" id="starRating">
					<input type="hidden" name="booktitle" id="booktitle">
					<input type="hidden" name="reviewBookISBN" id="reviewBookISBN">
				</div>
				<div id="btn_area">
					<button type="button" id="submitForm">글쓰기</button>
					<button type="button" id="goBack">글목록</button>
				</div>
			</form>
		</div>
		<div class="col-3"></div>
